...
class Product(models.Model):
    ...
    code = models.CharField('Product Code', max_length=10, help_text='Must be first 3 characters of the brand followed by yy-hh-mm')
    ...
    category = models.ManyToManyField(Category, help_text="Select available categories")
    flavors = models.ManyToManyField(Flavor, help_text="Select available flavors")
